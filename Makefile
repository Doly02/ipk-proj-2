...
# Header Files
HEADERS = include/SnifferConfig.hpp include/NetworkInterfacePrinter.hpp include/PrintIPv6Packet.hpp include/PrintIPv4Packet.hpp include/IPv4PacketSniffer.hpp
# Libraries
LIBS = -lpcap

# Source Files
SOURCES = src/SnifferConfig.cpp src/NetworkInterfacePrinter.cpp src/PrintIPv6Packet.cpp src/PrintIPv4Packet.cpp src/IPv4PacketSniffer.cpp src/main.cpp
# Object Files 
